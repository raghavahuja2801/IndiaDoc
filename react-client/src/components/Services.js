  ...
  const services = [
    {
      ...
      howTo: "Book an appointment, join the video call at the scheduled time, and discuss your health concerns with the doctor.",
    },
    {
      icon: <Pill className="h-8 w-8 text-orange-500" />,
      title: "Online Medicine Ordering",
      description: "Order prescribed medications and have them delivered to your doorstep.",
      howTo: "Upload your prescription, select the required medicines, make the payment, and wait for the delivery.",
    },
    {
      icon: <MessageCircle className="h-8 w-8 text-orange-500" />,
      title: "24/7 Chat Support",
      description: "Get instant answers to your health-related queries from our medical team.",
      howTo: "Open the chat feature in the app, type your question, and receive expert advice within minutes.",
    },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow bg-green-50 py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              ...
              >
                ...
                {/* How to Use */}
                <div className="mt-4">
                  <h4 className="font-semibold text-green-700 text-center">How to use:</h4>
                  <p className="mt-2 text-sm text-gray-600 text-center">{service.howTo}</p>
                </div>
        ...
        <div className="mt-12 text-center">
          <button className="px-6 py-3 bg-orange-500 text-white rounded-lg font-semibold text-lg hover:bg-orange-600">
